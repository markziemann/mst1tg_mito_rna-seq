...
colnames(xx) <- gsub("E","WT",colnames(xx))
colnames(xx) <- gsub("D","Mst1-TG",colnames(xx))

pdf("Mst1TG_young_plots.pdf")
...
write.table(dge,file="Mst1TG_young_deseq.tsv",quote=F,sep="\t")
...
unlink("Mst1TG_young_mitch.html")
mitch_report(res, outfile="Mst1TG_young_mitch.html")
mitch_plots(res, outfile="Mst1TG_young_mitch.pdf")
...
yy<-mitch_import(dge2, DEtype="deseq2", geneTable=gt)
res <- mitch_calc(yy, gsets)
unlink("Mst1TG_young_mitch_mouse.html")
mitch_report(res, outfile="Mst1TG_young_mitch_mouse.html")
mitch_plots(res, outfile="Mst1TG_young_mitch_mouse.pdf")
...
yy<-mitch_import(dge2, DEtype="deseq2", geneTable=gt)
res <- mitch_calc(yy, gsets)
unlink("Mst1TG_young_mitch_mouse_specificsets.html")
mitch_report(res, outfile="Mst1TG_young_mitch_mouse_specificsets.html")
mitch_plots(res, outfile="Mst1TG_young_mitch_mouse_specificsets.pdf")
